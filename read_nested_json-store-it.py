...
# Note this will applicable in linux OS not in windows
# os.system("cat F:\\bigdata\\datasets\\opdata\\result/p* > resdata.csv")
# os.system("rm -rf F:\\bigdata\\datasets\\opdata\\result/p*")